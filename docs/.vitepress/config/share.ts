...
export const sharedConfig = withMermaid(
  defineConfig({
    ...
    metaChunk: true,
    lang: "zh-CN", // 语言
    title: "FirPE 官方帮助文档", // 站点名称
    titleTemplate: "官方帮助文档", // 网页标题
    description: "FirPE 官方帮助文档", // 站点描述
    head: [
      // favicon.ico 图标等
      [
        "link",
        { rel: "shortcut icon", href: `${VITE_BASE_URL || "/"}logo.svg` },
      ],
      // 网站 favicon.ico 图标
      [
        "link",
      ...
      // 关键词和描述
      ["meta", { name: "keywords", content: "FirPE 帮助文档" }],
      ["meta", { charset: "UTF-8" }],
    ],
      ...
      plugins: [
        groupIconVitePlugin({
          customIcon: {
            ...
            java: localIconLoader(
              import.meta.url,
              "../../public/iconify/java.svg"
            ),
    ...
    themeConfig: {
      ...
      editLink: {
        pattern:
          "https://github.com/834772509/FirPE-Docs/edit/master/docs/:path",
